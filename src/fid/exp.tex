...
\begin{figure}
  \centering
  \subfloat[ ]{
  \includegraphics[width=2.2in,height=1.7in]{fid/figures/hogvsift/mean_normalized_error.png}}
  \subfloat[ ]{
  \includegraphics[width=2.2in,height=1.7in]{fid/figures/hogvsift/failure_rate.png}
...
% % variation.                                                                     
% 
\subsection{Varying Number of Exemplars}
...
Please refer to supplementary for additional outputs.
 ...
 \begin{figure}
  \centering
  \subfloat[]{\includegraphics[width=1.35in,height=1.2in]{fid/figures/shapevsapp/mean_error.png}\label{fig:sva_shape_mean}}
  \subfloat[]{\includegraphics[width=1.35in,height=1.2in]{fid/figures/shapevsapp/failure_rate.png}\label{fig:sva_shape_fail}}
...
\subsection{Clustering vs Eigenspace Analysis}
...
% % \begin{figure}
% %   \centering
% %   \includegraphics[width=1.5in,height=1.0in]{figures/iccv_version_one/cofw/kmeans_shape_vs_kmeans_pca/mean_err_modified.jpg}
% %   \includegraphics[width=1.5in,height=1.0in]{figures/iccv_version_one/cofw/kmeans_shape_vs_kmeans_pca/fail_rate_modified.jpg}
...
% %%% \end{table}  
% 
% \paragraph{Euclidean distance vs Metric Learning}
...
% We learn
% the transformation matrix based on~\cite{weinberger09distance}. The authors learn the metric with the objective of
...
% Please refer to supplementary material for figures. We note that insignificant improvement is
% obtained
% using metric learning.
% Figure [x] shows the failure rate analysis of different datasets. We see similarity score computed
...
% \begin{figure}
%   \centering
%   \includegraphics[width=1.5in,height=1.0in]{figures/iccv_version_one/cofw/wo_metric_vs_w_metric/mean_err_modified.jpg}
%   \includegraphics[width=1.5in,height=1.0in]{figures/iccv_version_one/cofw/wo_metric_vs_w_metric/fail_rate_modified.jpg}
%   \caption{ Comparison of Metric Learning Result. }
